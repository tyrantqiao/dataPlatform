...
def on_message(client, userdata, msg):
    ...
    Data.objects.create(device_id_id=nodeId,val=val,data=json_data['data'],fPort=json_data['fPort'],confirmed=json_data['confirmed'],intensity=intensity,safe=True,unit="du",reference=json_data['reference'])
    #print(create_data)
    #create_data.save()
    print("saving done")
    print(json_data)
